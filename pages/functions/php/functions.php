...
?>
    ...
    <link rel="stylesheet" href="/barbearia/pages/CSS/style.css">
<?php
}
...
?>
    ...
    <label for="check" id="labelMenu">
        <img src="\barbearia\pages\IMAGES\menu.png" id="imgMenu" style="cursor:pointer;">
    </label>
    <nav id="menu">
        <ul id="ulMenu">
            <li>
                <a href="\barbearia\pages\cadastro.php" class="linkMenu">Início</a>
            </li>
            <li>
...
?>
    ...
    <script type="text/javascript" src="/barbearia/pages/functions/js/mascaras.js"></script>
<?php
}
...
?>
    ...
    <script type="text/javascript" src="/barbearia/pages/functions/js/jquerymask/dist/jquery.mask.min.js"></script>
    <script type="text/javascript" src="/barbearia/pages/functions/js/mascaras.js"></script>
    <script type="text/javascript" src="\barbearia\pages\functions\js\datatimepicker.js"></script>
